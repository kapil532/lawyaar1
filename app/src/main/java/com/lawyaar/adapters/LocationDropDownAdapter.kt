...
class LocationDropDownAdapter(val context: Context) : BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        vh.label.text = dataSource.get(position).city



        return view
    }
    var dataSource=ArrayList<LocationModelItem>()

    fun setUpdateData( dataSource:ArrayList<LocationModelItem>)
    {
