...
class LawyaarAdapter() : RecyclerView.Adapter<LawyaarAdapter.MyVeiwHolder>() {
    ...
    override fun onBindViewHolder(viewHolder: MyVeiwHolder, i: Int) {
        ...
        var caseS = ""
        var langS = ""
        if (currentitem.caseCategories.isNotEmpty()) {
        ...
        viewHolder.lawyaar_price_actual.text =
            "" + currentitem.advocateDetail.actualPrice + "/Session"
        ...
        viewHolder.lawyaar_price_offer.text =
            "" + currentitem.advocateDetail.offerPrice + "/Session"
        //

        viewHolder.lawyaaricon.setOnClickListener {
            val lawyaarTransfer = LawyaarTransfer(
                currentitem.advocateDetail.advocateDetailId,
                currentitem.userId,
                (currentitem.caseCategories),
